...
public class TCPClient {
    ...
    private void waitForMessages(Socket socket, Scanner scanner, DataInputStream dataInputStream, DataOutputStream dataOutputStream) throws IOException {
        //Loop and Wait for messages.
        boolean doRun = true;
        while (doRun){
            dataOutputStream.writeUTF("ready_for_action");
